...
def plotly_log(well_data, depth_uom=""):  # noqa
    ...
    fig.update_layout(
        ...
        xaxis2=dict(title='RT', titlefont=dict(color=COLOR_DICT['RT'], size=font_size),
                    tickfont=dict(color=COLOR_DICT['RT'], size=font_size), side='top', anchor='free', position=.87,
        ...
        xaxis8=dict(title='LITHOLOGY', titlefont=dict(color='black', size=font_size),
                    ...
                    side='top', anchor='free', position=.87, title_standoff=.1,
        ...
        yaxis=dict(domain=[0, .86], title=f'DEPTH ({depth_uom})'),
        yaxis2=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis3=dict(domain=[0, .86]),
        yaxis4=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis5=dict(domain=[0, .86]),
        yaxis6=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis7=dict(domain=[0, .86]),
        yaxis8=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis9=dict(domain=[0, .86]),
        yaxis10=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis11=dict(domain=[0, .86]),
        yaxis12=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis13=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis14=dict(domain=[0, .86], visible=False, showgrid=False),
        yaxis15=dict(domain=[0, .86]),
        yaxis16=dict(domain=[0, .86], visible=True, showgrid=False),
